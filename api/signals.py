...
def send_article_approved(sender, instance, created, **kwargs):
    """
    Trigger actions when an article is approved:
    ...
    subscribers = list(instance.author.subscribed_readers.all())

    if instance.publisher:
        subscribers += list(instance.publisher.subscribed_readers.all())
